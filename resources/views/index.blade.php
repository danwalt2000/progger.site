...
@section('description', "Я - разработчик: создаю быстрые, функциональные и красивые сайты, осуществляю поддержку приложения после разработки, помогаю с настройкой модулей, расширений, приложений. Сделаю для вас продающий сайт, который гарантированно принесет прибыль!")
