@extends("layouts.app",[
    'title'=>"Мой блог",
    'description'=>"Статьи о создании, оформлении и продвижении сайтов, разбор технологий и предложений на рынке IT-услуг, секреты и хитрости, которые помогут вам опередить конкурентов"
])
