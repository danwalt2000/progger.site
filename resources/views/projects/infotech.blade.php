<?php
$title = "Интернет-магазин на Вордпрессе";
$description = "Небольшой интернет-магазин торгового и кассового оборудования на Wordpress";
$underline = 3;
?>
    ...
    <div class="project-details" style="box-sizing:border-box;">
        ...
        <div class="project-details-secondary">
            ...
            <div class="project-details-block">
                ...
                <a class="buttonBlockElement" rel="nofollow" href="http://infoteh-dnr.000webhostapp.com" target="_blank">Перейти на сайт</a>
            </div>
        </div>
    </div>
            </main>
