...
$description = "Почему вам стоит заказать сайт у меня?";
$underline = 2;
?>
            ...
            <div class="page-content">
                <div class="layout">
                    ...
                    <div class="briefBackgroundBlock">
                        ...
                        <div class="MyCol2">
                            <div class="paddingMy">
                                <p class="homepageDescription">Я - веб-дизайнер и программист широкого профиля. Разрабатываю быстрые, функциональные и красивые сайты, специализируюсь на как верстке, так и на настройке серверной части сайтов и веб-приложений. Я считаю, что высококлассный веб-дизайн должен быть чистым, простым, и привлекающим внимание пользователя.</p>
                            </div>
                        </div>
                        <div class="MyColSide">
                            <div class="My-block-image"></div>
                        ...
                        <div class="wrap cf text-c">
                            ...
                            <div class="splitColumnsMy">
                                ...
                                <p class="servicesParagraph">
                                    Веб-дизайн - это моя страсть. Я регулярно слежу за трендами в этой области и повышаю квалификацию, внедряя в свою практику современные подходы к сайтостроению. 
                                </p>
                            </div>
                        </div>
