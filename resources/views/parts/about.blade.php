<div class="layout">
    ...
    <div class="briefBackgroundBlock">
        ...
        <div class="MyCol2">
            <div class="paddingMy">
                <p class="homepageDescription">Я - веб-разработчик широкого профиля. Создаю быстрые, функциональные и красивые приложения, специализируюсь на CMS и фреймворках на языке PHP. Сопровождаю разработку приложения начиная с концепии, и заканчивая развертыванием на продакшн.</p>
            </div>
        </div>
        <div class="MyColSide">
            <div class="My-block-image"></div>
    ...
    <div class="myServices">
        ...
        <div class="wrap cf text-c">
            ...
            <div class="splitColumnsMy">
                ...
                <h2>Front-end</h2>
                <p class="servicesParagraph">Оптимизация клиентской стороны приложения позволяет не только повысить производительность сайта, но и гарантировать стабильное исполнение кода на разных устройствах.</p>
            </div>
        </div>
