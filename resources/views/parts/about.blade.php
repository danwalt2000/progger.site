            ...
            <div class="splitColumnsMy">
                ...
                <p class="servicesParagraph">
                    {{-- Создав десятки сайтов и приложений,  --}}
                     Оптимизация клиентской стороны приложения позволяет не только повысить производительность сайта, но и гарантировать стабильное исполнение кода на разных устройствах.</p>
            </div>
        </div>
