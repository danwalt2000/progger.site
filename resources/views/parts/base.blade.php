    ...
    @production
        ...
        <script>
            ...
            <script type="text/javascript" >
                ...
                ym({{ App::currentLocale() == 'en' ? 98389079 : 91894049 }}, "init", {
                    clickmap:true,
                    trackLinks:true,
                    accurateTrackBounce:true
                });
            </script>
            <noscript><div><img src="https://mc.yandex.ru/watch/{{ App::currentLocale() == 'en' ? 98389079 : 91894049 }}" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
            <!-- /Yandex.Metrika counter -->
    @endproduction
</body>
